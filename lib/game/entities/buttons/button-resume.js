...
.defines(function() {
	...
	EntityButtonResume = EntityButton.extend({
		...
		vertical: "center",
		horizontal: "center",
		idleSheetInfo: { sheetImage:new ig.Image('media/graphics/sprites/buttons/button-resume.png'), sheetX:1, sheetY:1 },
		scaling: true,
		...
		clicked:function() {
			...
			if(ig.game.easing == false) {
				...
				ig.game.easing = true; // false on pop-up-pause.js => easeOut()
