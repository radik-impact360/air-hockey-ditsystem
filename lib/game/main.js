...
.requires(
    ...
    // CONTROLLERS
    'game.entities.controllers.game-controller',
    'game.entities.controllers.menu-controller',
    ...
    'game.entities.buttons.button-text-play',

    // ENTITIES GAME
    'game.entities.menu.menu-title',
    'game.entities.menu.puck-title',
    'game.entities.menu.pop-up-settings',
    'game.entities.menu.pop-up-tutorial',
    'game.entities.game.puck',
    'game.entities.game.paddle',
    'game.entities.game.ui-game',
    'game.entities.game.pop-up-pause',
    'game.entities.game.pop-up-result',
    'game.entities.game.tutorial-step',
