        ...
        ig.SizeHandler = ig.Class.extend({
            ...
            sizeCalcs: function () {
                ...
                if (ig.ua.mobile) {
                    ...
                    var mobileTempSize = new Vector2(this.mobile.actualResolution.x, this.mobile.actualResolution.y);
                    ...
                    var desktopTempSize = new Vector2(this.desktop.actualResolution.x, this.desktop.actualResolution.y);
