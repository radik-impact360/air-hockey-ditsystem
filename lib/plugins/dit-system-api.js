    ...
    DitSystemApi = ig.Class.extend({
        ...
        okayButtton: function() {
                ...
                if(this.okayButtonDIV) {
                        this.okayButtonDIV.setAttribute("style", "color:black; background-color: #fff; z-index: 999999; border: 2px solid #fff; font-size:20px; border-radius: 5px; position: absolute; float: left; top: 70%; left: 50%; transform: translate(-50%, -30%);"); 
